    ...
    <div class="px-6 pt-6 lg:px-8">
      ...
      <nav aria-label="Global" class="flex items-center justify-between">
        ...
        <div class="flex flex-1 justify-end">
          <a class="flex gap-2" href="https://github.com/rbcrossley/randomNepaliNameGenerator" target="_blank">
            <svg aria-hidden="true" class="h-6 w-6 fill-slate-900" viewBox="0 0 24 24">
